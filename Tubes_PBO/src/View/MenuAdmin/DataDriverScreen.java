 ...
 * @author Asus
 */
public class DataDriverScreen extends JFrame implements ActionListener{
    ...
    public DataDriverScreen() {
       ...
       // }
        String tabelkolom[] = {"ID","Nama","Alamat","jemput","Jenis Kendaraan","Plat Nomor","Pendapatan","Status"};
